...
<body>
	...
	<div class="body-box" style="float: right">
		<form id="jvForm" action="updateAdvert.do?id=${adv.id }"  method="post"  onsubmit="return chkAll()">
				...
				<tbody>
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required"  value="${adv.title}" name="title" maxlength="100"  id="loginname"  onblur="chkloginname()"/>
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required"   value="${adv.content}" name="content" maxlength="100"  id="content"   onblur="chkContent()"/>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="Wdate"   value="${adv.crtime}" name="crtime" maxlength="100"   onclick="WdatePicker()"/></td>
					</tr>
						<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
							class="pn-frequired">*</span>创建人:</td>
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required"   value="${adv.cman}" name="cman" maxlength="100"  id="cman"  onblur="chkCman()"/>
